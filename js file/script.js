...
navLinks[0].addEventListener('click', ()=> {
  section[1].classList.add('hiding')
  section[2].classList.add('hiding')
  section[0].classList.remove('hiding')

})
navLinks[1].addEventListener('click', ()=> {
  section[0].classList.add('hiding')
  section[2].classList.add('hiding')
  section[1].classList.remove('hiding')

})
navLinks[2].addEventListener('click', ()=> {
  section[0].classList.add('hiding')
  section[1].classList.add('hiding')
  section[2].classList.remove('hiding')
...
function showProduct(productFilter){
    ...
    productFilter.forEach(card=>{
        ...
        newButton.setAttribute('onclick',`addCart(${listProducts.id})`)
